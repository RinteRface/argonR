expr <- htmltools::tags$html(
  ...
  htmltools:::takeHeads(
    htmltools::tags$head(
      ...
      htmltools::tags$link(type = "text/css", href = "inst/assets/css/argon.css", rel = "stylesheet")
  ...
  htmltools::tags$body(
    htmltools::tags$header(
      class = "header-global", 
      htmltools::HTML(
        '<nav id="navbar-main" class="navbar navbar-main navbar-expand-lg navbar-transparent navbar-light headroom headroom--not-top headroom--not-bottom headroom--pinned">
      <div class="container">
        ...
        <li class="nav-item">
        <a class="nav-link nav-link-icon" href="https://github.com/creativetimofficial/argon-design-system" target="_blank" data-toggle="tooltip" title="" data-original-title="Star us on Github">
    ...
    htmltools::tags$main(
      htmltools::HTML(
        ...
        <p class="lead  text-white">The design system comes with four pre-built pages to help you get started faster. You can change the text and images and you are good to go.</p>
          ...
          <p>The kit comes with three pre-built pages to help you get started faster. You can change the text and images and you are good to go.</p>
        ...
        <h3>Our customers</h3>
        <p class="lead">Do not let your uses guess by attaching tooltips and popoves to any element. Just make sure you enable them first via JavaScript.</p>
          <p>The kit comes with three pre-built pages to help you get started faster. You can change the text and images and you are good to go.</p>
        <p>The kit comes with three pre-built pages to help you get started faster. You can change the text and images and you are good to go.</p>
          ...
          <p class="text-white mt-3">Some quick example text to build on the card title and make up the bulk of the cards content.</p>
        </div>
        <div class="col-lg-4">
        <div class="icon icon-lg icon-shape bg-gradient-white shadow rounded-circle text-primary">
    ...
    # Optional JS -->
    #htmltools::includeScript(path = "./assets/vendor/onscreen/onscreen.min.js"),
    ...
    # Argon JS -->
    htmltools::tags$script(src = "inst/assets/js/argon.js")
  )
)

expr <- paste0(as.character(expr), collapse = "\n")
